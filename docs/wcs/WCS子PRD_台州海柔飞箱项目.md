...
| 时间 | 版本 | 变更人 | 主要变更内容 |
|---|---|---|---|
| 2026-08-08 | v1.5 | Stone JIANG | 产出配套接口文档《台州海柔飞箱项目_WCS接口文档_v1.0.xlsx》（28 页签、27 个接口契约），门店 WMS 与海柔均按其开发；§7.7-R13 结项 |
...
> 清单中**中间层的接口访问地址列原本全部空白，已由 WCS 定义并回填**，见 §7.3。
> **本节内容已整理为独立的接口文档《台州海柔飞箱项目_WCS接口文档_v1.0.xlsx》（28 个页签、27 个接口契约），门店 WMS 与海柔双方均按该文档开发**；本节保留为 PRD 内的设计说明与决策依据。
...
| **R13** | ✅ **已解决** —— 接口文档已重出：《台州海柔飞箱项目_WCS接口文档_v1.0.xlsx》，28 个页签、27 个接口契约，中间层统一为 WCS，流向统一写作「门店 WMS → WCS → 海柔 WES」，海柔 → WCS 的 7 个接口地址已由 WCS 定义并回填 | 三方以新版接口文档为唯一开发基线，原清单不再作为开发依据 | 已完成 | 请海柔与门店 WMS 确认新版接口文档后开始开发；如对字段有异议在评审会上提出 |
...
| **《台州海柔飞箱项目_WCS接口文档_v1.0.xlsx》** | **本项目接口基线，门店 WMS 与海柔均按此开发。随本 PRD 一同交付** |
| 《台州飞箱（WCS-海柔接口）》 | 海柔原接口清单，已于 v1.2 完成逐字段核对；其内容已并入上方新版接口文档，后续以新版为准 |
